...
public class Joystick : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler, IPointerDownHandler, IPointerUpHandler
{
    ...
    private Vector2 defaultMeterPosition;
    ...
    private void Start()
    {
        ...
        defaultMeterPosition = meter.anchoredPosition;
    ...
    {
        meter.anchoredPosition = eventData.position - rect.anchoredPosition - anchoredShiftVector;
    ...
    {
        OnClick.Invoke();
        meter.anchoredPosition = defaultMeterPosition;
        stick.anchoredPosition = defaultStickPosition;
    }
}
